...
- [ ] **03-01 Angular Project Scaffold** — Angular 19 standalone, SCSS, proxy config, route stubs
...
- [ ] **05-01 Docker** — Multi-stage Dockerfiles (backend + frontend), nginx proxy, docker-compose
